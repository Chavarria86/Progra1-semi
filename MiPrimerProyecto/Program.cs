    ...
    class Program
    {
        ...
        static double media(string[] serie)
        {
            ...
            while (continuar)
            {
                ...
                {
                    case 1:
                        Conversor("Monedas", new string[] { "Dolar", "Dolar Canadiense", "Peso Mexicano", "Real brasileño", "Peso argentino", "Peso colombiano", "Sol peruano", "Peso chileno", "Peso uruguayo", "Quetzal guatemalteco" },
                            new double[,] {
                             { 1.00, 1.36, 18.12, 5.21, 365.28, 4227.89, 3.77, 755.93, 39.29, 7.85 },
                             { 0.74, 1.00, 13.30, 3.82, 268.69, 3113.25, 2.77, 556.87, 28.87, 5.78 },
                             { 0.055, 0.075, 1.00, 0.29, 20.16, 23.39, 0.21, 41.20, 2.18, 0.40 },
                             { 0.19, 0.26, 3.47, 1.00, 6.80, 8.12, 0.71, 138.42, 7.06, 1.42 },
                             { 0.0027, 0.0037, 0.049, 0.15, 1.00, 1.19, 0.10, 20.37, 1.02, 0.21 },
                             { 0.00024, 0.00032, 0.043, 0.12, 0.84, 1.00, 0.085, 1.71, 0.089, 0.017 },
                             { 0.27, 0.37, 4.80, 1.41, 10.12, 11.77, 1.00, 20.21, 1.05, 0.21 },
                             { 0.0013, 0.0018, 0.023, 0.0072, 0.049, 0.58, 0.049, 1.00, 0.052, 0.010 },
                             { 0.025, 0.034, 0.46, 0.14, 0.98, 11.22, 0.95, 19.24, 1.00, 0.19 },
                             { 0.13, 0.18, 2.50, 0.70, 4.78, 58.87, 4.80, 98.78, 5.24, 1.00 }
